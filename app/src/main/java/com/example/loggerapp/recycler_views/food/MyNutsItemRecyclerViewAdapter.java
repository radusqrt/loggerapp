...
import com.example.loggerapp.content.food.NutsContent.NutsItem;
import com.example.loggerapp.databinding.FragmentNutsItemBinding;
...
/**
 * {@link RecyclerView.Adapter} that can display a {@link NutsItem}.
 */
public class MyNutsItemRecyclerViewAdapter extends RecyclerView.Adapter<MyNutsItemRecyclerViewAdapter.ViewHolder> {

    private final List<NutsItem> mValues;
    private final Fragment mReferencedFragment;

    public MyNutsItemRecyclerViewAdapter(List<NutsItem> items, Fragment referencedFragment) {
        mValues = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(FragmentNutsItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                logsRef.child(key).child("food").child("type").setValue("nuts");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public NutsItem mItem;

        public ViewHolder(FragmentNutsItemBinding binding) {
